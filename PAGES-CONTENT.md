...
- **People** (`people/index.html`): the numbered photo slideshows are configured in `people/albums.json`. Replace the temporary album names and add photo paths, descriptions, and optional captions. See `people/README.md` for the format. Empty albums show a coming-soon state.
...
- **Objects** (`objects/index.html`): bilingual EN/UA Ritual Request, with page-specific `objects/ritual.css` and `objects/ritual.js`. See `objects/README.md` for intake and payment integration status.
